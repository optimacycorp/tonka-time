...
CHECKBOX_TOKEN_LINES = [
    ("is_property_owner_yes", "Property owner?"),
    ("is_property_owner_no", "Property owner?"),
    ("owner_permission_yes", "Owner permission confirmed?"),
    ("owner_permission_no", "Owner permission confirmed?"),
...
def main() -> int:
    ...
    doc.save(str(target))
    normalize_checkbox_placeholders(target)
    return 0
...
def normalize_checkbox_placeholders(target: Path) -> None:
